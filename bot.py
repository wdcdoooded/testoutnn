...
def summarize_with_gemini(raw_news):
    prompt = (
        ...
        "1. จัดกลุ่มข่าวลงใน 5 หมวดหมู่นี้เท่านั้น: [1. ข่าวเทคโนโลยี, 2. ข่าวปัญญาประดิษฐ์ (AI), 3. ข่าวธุรกิจ, 4. ข่าวต่างประเทศ, 5. ข่าววิทยาศาสตร์] \n"
        "2. หากไม่มีข่าวที่ตรงกับหมวดหมู่ใด ให้ข้ามหมวดหมู่นั้นไปเลย ห้ามสร้างหมวดหมู่ใหม่เด็ดขาด\n"
        "3. สรุปเนื้อหาให้สั้นและกระชับที่สุด (จำกัดความยาวไม่เกิน 2 ประโยคต่อ 1 ข่าว) ในรูปแบบเครื่องหมายหัวข้อย่อย (Bulletpoint)\n"
