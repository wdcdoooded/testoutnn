...
def summarize_with_gemini(raw_news):
    prompt = (
        ...
        "3. สรุปเนื้อหาให้สั้นและกระชับที่สุด ในรูปแบบเครื่องหมายหัวข้อย่อย (Bulletpoint)\n"
        ...
        "6. สำคัญมาก: เนื้อหาทั้งหมดรวม Source Link ต้องไม่เกิน 2000 คำ โปรดตรวจสอบให้แน่ใจก่อนทุกครั้ง\n\n"
